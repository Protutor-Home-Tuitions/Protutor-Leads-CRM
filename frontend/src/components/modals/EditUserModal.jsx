    ...
    >
      ...
      <div style={{
        ...
        <div style={{ padding: '20px 24px 12px' }}>
          <h2 style={{ fontSize: '16px', fontWeight: 800, color: '#111827', margin: 0 }}>Edit Employee</h2>
          <p style={{ fontSize: '12px', color: '#9ca3af', marginTop: '2px' }}>Update team member details and access</p>
        </div>
        ...
        <div style={{ padding: '0 24px 16px', display: 'flex', flexDirection: 'column', gap: '14px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
            ...
            <div>
              ...
              <input type="password" value={form.password} onChange={(e) => setField('password', e.target.value)} placeholder="Leave blank to keep"
                style={{ marginTop: '4px', width: '100%', height: '36px', border: '1px solid #e5e7eb', borderRadius: '6px', padding: '0 10px', fontSize: '13px', outline: 'none', boxSizing: 'border-box' }}
              />
            </div>
          </div>
